...
Метод save() принимает URL ресурса, где будет опубликован пост. В примере выше сообщение будет опубликована в ленте сообщений пользователя person.
